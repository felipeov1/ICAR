...
public class CustomerAddressMapperImpl implements CustomerAddressMapper {
    ...
    public CustomerAddressResponse toResponse(CustomerAddress entity) {
        ...
        CustomerAddressResponse customerAddressResponse = new CustomerAddressResponse( id, addressName, zipCode, city, state, street, streetNumber, additionalInstructions, createdAt, updatedAt );
