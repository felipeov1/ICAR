...
import com.icar.plataform.application.service.payment.coupon.AppliedCouponService;
...
public class AppliedCouponController {
    ...
    public ResponseEntity<Integer> countUsesByCustomerAndCoupon(
            @PathVariable UUID couponId,
            @PathVariable UUID customerId) {
        return ResponseEntity.ok(appliedCouponService.countUsesByCustomerAndCoupon(customerId, couponId));
    }
