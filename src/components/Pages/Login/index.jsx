      ...
      >
        ...
        <div className="w-11/12 sm:max-w-md p-6 bg-transparent backdrop-blur-sm rounded-lg flex flex-col items-center mt-auto md:mt-0">
          ...
          <div className="flex items-center my-4 w-full">
            <div className="h-px flex-1 bg-blue-900"></div>
            <span className="mx-2 text-sm text-blue-900">ou</span>
            <div className="h-px flex-1 bg-blue-900"></div>
          </div>
          ...
          <a
            type="button"
            href="/criar-conta"
            className="w-full py-2 px-4 border text-center border-blue-900 lg:text-blue-900 text-white font-bold rounded-lg hover:bg-blue-900 hover:text-white focus:ring-2 focus:ring-blue-900"
          >
            Fazer Cadastro
          </a>
        </div>
